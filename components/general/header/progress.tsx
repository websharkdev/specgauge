...
const ProgressBar = ({
    ...
    return <HoverCard onOpenChange={setHovered}>
        <HoverCardTrigger className={`p-0 w-[120px]`}><Badge className={`w-full transition-all duration-700 cursor-pointer h-8 ${hovered ? '' : 'rounded-full'} px-3.5 border-none bg-[#F1F1F1]`}>
        ...
        <HoverCardContent align="end" sideOffset={-32} className={`static z-[100] shadow-none rounded-xl border-none bg-[#F1f1f1] ${hovered ? '!w-[180px] h-max' : ''}`}>
            <div
