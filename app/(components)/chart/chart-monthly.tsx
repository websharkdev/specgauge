...
const CMonthly = ({ index }: { index: number }) => {
    ...
    return (
        <div ref={ref}
            id="pain_point_1"
            className={`relative inset-0 snap-normal md:snap-start ${isMobile ? 'col-span-full' : 'col-span-1'} flex flex-col md:justify-start justify-center gap-4 lg:overflow-hidden h-auto lg:h-full 2xl:pt-ds-[128] sm:pt-ds-[80] py-[50px] sm:px-ds-[44] px-0 border-r border-[#00000050] bg-[#E5E8EF]`}>
